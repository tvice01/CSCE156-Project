...
insert into Person (personCode, firstName, lastName, address_id) values
	("ddb007", "Mary", "Grey", 
		(select address_id from Address where address_id = (select address_id from Address where street = "233 Bay State Road" and city = "Boston" and zip = "02101" and state_id = (select state_id from State where name = "MA")))
	),
	("adc001", "Shelly", "Smith", 
