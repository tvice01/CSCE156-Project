...
public class Parser {
	...
	//A method that builds a Product ArrayList from the contents of the 'Products.dat' file
		...
		//Parse the entries of each line into Product and add them to the 'productsList' list
		while (s.hasNext()) {
			String line = s.nextLine();
			if(!line.trim().isEmpty()) {
				Product p = null;
